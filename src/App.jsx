    ...
    <AuthContext.Provider value={authMethods}>
      <div className="min-h-screen bg-gradient-to-br from-surface-50 via-white to-primary-50 dark:from-surface-900 dark:via-surface-800 dark:to-surface-900">
        <Routes>
          ...
          <Route path="/invoices" element={isAuthenticated ? <Invoices /> : <Login />} />
          <Route path="/clients" element={isAuthenticated ? <Clients /> : <Login />} />
          <Route path="/settings" element={isAuthenticated ? <Settings /> : <Login />} />
          <Route path="/track-payments" element={isAuthenticated ? <TrackPayments /> : <Login />} />
          <Route path="/send-share" element={isAuthenticated ? <SendShare /> : <Login />} />
